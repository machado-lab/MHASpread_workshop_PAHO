# Scenario 3 (multihost, initial infection in cattle)
...
population$I_bov_pop[population$node== 286] <- 10                 # Infected 10 bovine in the farm id = 286
...
model_1     <- SEIR_model(population = population,                                                 #  Population database
                          ...
                          days_of_simulation = 10,                                                 #  Silent spread duration in days
...
`population$I_bov_pop[population$node== 286] <- 10`
