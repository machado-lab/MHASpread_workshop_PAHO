...
| Important concepts of disease transmission modeling *Afternoon (1:00 PM-5:00 PM) | _Welcome & introductions_ <br /> <br /> Importance of the response plan in outbreak events. <br /> Introduction to disease transmission models <br /> How simulation models can help the design and update of control strategies. <br /> How to integrate the model outputs with real case scenarios._ |  
